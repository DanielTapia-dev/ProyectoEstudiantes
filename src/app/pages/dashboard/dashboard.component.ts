  ...
  constructor(private productosService: ProductosService) {
    this.productosService.getProductos().subscribe(resp => {
      ...
      for (let i = 0; i < this.productos.length; i++) {
        ...
        if (this.productos[i].categoria === "Bebidas" && this.productos[i].estado == true) {
          this.bebidas.push(this.productos[i]);
        } else if(this.productos[i].categoria === "Pizzas" && this.productos[i].estado == true) {
          this.pizzas.push(this.productos[i]);
        }else if (this.productos[i].categoria === "Hamburguesas" && this.productos[i].estado == true){
